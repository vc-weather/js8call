...
static constexpr auto qt_meta_stringdata_ZN15TransceiverBaseE = QtMocHelpers::stringData(
    "TransceiverBase"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15TransceiverBaseE[] = {
...
Q_CONSTINIT const QMetaObject TransceiverBase::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15TransceiverBaseE.offsetsAndSizes,
    qt_meta_data_ZN15TransceiverBaseE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15TransceiverBaseE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TransceiverBase, std::true_type>
    >,
    nullptr
} };
...
void *TransceiverBase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15TransceiverBaseE.stringdata0))
