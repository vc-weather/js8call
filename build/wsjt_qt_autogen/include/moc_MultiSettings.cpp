...
static constexpr auto qt_meta_stringdata_ZN13MultiSettingsE = QtMocHelpers::stringData(
    "MultiSettings",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13MultiSettingsE[] = {
...
Q_CONSTINIT const QMetaObject MultiSettings::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13MultiSettingsE.offsetsAndSizes,
    qt_meta_data_ZN13MultiSettingsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13MultiSettingsE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MultiSettings, std::true_type>,
        // method 'configurationNameChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<QString, std::false_type>,
        // method 'select_configuration'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void MultiSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (MultiSettings::*)(QString ) const;
            if (_q_method_type _q_method = &MultiSettings::configurationNameChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *MultiSettings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13MultiSettingsE.stringdata0))
